...
int REDIS_BLOCKSZ_MIN = 128; /*Max block size to redistribute if undefined FORZE_REDIS_SIZE */
...
void parsec_wrapper_devices_release_memory_(){
    parsec_devices_release_memory();
}

void parsec_wrapper_devices_reset_load_(){
	if( parsec_ctx != NULL ){
