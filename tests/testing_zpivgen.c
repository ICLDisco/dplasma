...
int main(int argc, char ** argv)
{
    ...
    if (check) {
                ...
                for( m=0; m<nbM; m++) {
                    for( n=0; n<nbN; n++) {
                        for( r=0; r<2; r++) {
                            ...
                            B = parsec_tiled_matrix_submatrix((parsec_tiled_matrix_t*)&dcA, 0, 0, allM[m], allN[n] );
        ...
        /*dplasma_qrtree_print_dag( (parsec_tiled_matrix_t*)&dcA, &qrtree, dot_filename );*/
        ret = dplasma_qrtree_check( (parsec_tiled_matrix_t*)&dcA, &qrtree );

        /* dplasma_qrtree_print_pivot(   (parsec_tiled_matrix_t*)&dcA, &qrtree); */
        /* dplasma_qrtree_print_next_k(  (parsec_tiled_matrix_t*)&dcA, &qrtree, 0); */
        /* dplasma_qrtree_print_prev_k(  (parsec_tiled_matrix_t*)&dcA, &qrtree, 0); */
        /* dplasma_qrtree_print_nbgeqrt( (parsec_tiled_matrix_t*)&dcA, &qrtree ); */
        /* dplasma_qrtree_print_type   ( (parsec_tiled_matrix_t*)&dcA, &qrtree ); */
