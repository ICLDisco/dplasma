...
dplasma_zhetrf_New( parsec_tiled_matrix_t *A, int *INFO)
{
    ...
    dplasma_add2arena_tile( &((parsec_zhetrf_taskpool_t*)parsec_zhetrf)->arenas_datatypes[PARSEC_zhetrf_DEFAULT_ADT_IDX],
...
dplasma_zhetrf_Destruct( parsec_taskpool_t *tp )
{
    ...
    dplasma_matrix_del2arena( &obut->arenas_datatypes[PARSEC_zhetrf_DEFAULT_ADT_IDX] );
...
dplasma_ztrmdm_New( parsec_tiled_matrix_t *A)
{
    ...
    dplasma_add2arena_tile( &((parsec_ztrmdm_taskpool_t*)parsec_ztrmdm)->arenas_datatypes[PARSEC_ztrmdm_DEFAULT_ADT_IDX],
                            A->mb*A->nb*sizeof(dplasma_complex64_t),
                            PARSEC_ARENA_ALIGNMENT_SSE,
                            parsec_datatype_double_complex_t, A->mb );
...
dplasma_ztrmdm_Destruct( parsec_taskpool_t *tp )
{
    ...
    dplasma_matrix_del2arena( &obut->arenas_datatypes[PARSEC_ztrmdm_DEFAULT_ADT_IDX] );
