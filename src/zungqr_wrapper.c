                    ...
                    parsec_tiled_matrix_t *Q )
{
    ...
    /* Default type */
    dplasma_add2arena_tile( &tp->arenas_datatypes[PARSEC_zungqr_DEFAULT_ADT_IDX],
                            A->mb*A->nb*sizeof(dplasma_complex64_t),
                            PARSEC_ARENA_ALIGNMENT_SSE,
                            parsec_datatype_double_complex_t, A->mb );

    /* Lower triangular part of tile without diagonal */
    dplasma_add2arena_lower( &tp->arenas_datatypes[PARSEC_zungqr_LOWER_TILE_ADT_IDX],
                             A->mb*A->nb*sizeof(dplasma_complex64_t),
                             PARSEC_ARENA_ALIGNMENT_SSE,
                             parsec_datatype_double_complex_t, A->mb, 0 );

    /* Little T */
    dplasma_add2arena_rectangle( &tp->arenas_datatypes[PARSEC_zungqr_LITTLE_T_ADT_IDX],
...
dplasma_zungqr_Destruct( parsec_taskpool_t *tp )
{
    ...
    dplasma_matrix_del2arena( &parsec_zungqr->arenas_datatypes[PARSEC_zungqr_DEFAULT_ADT_IDX   ] );
    dplasma_matrix_del2arena( &parsec_zungqr->arenas_datatypes[PARSEC_zungqr_LOWER_TILE_ADT_IDX] );
    dplasma_matrix_del2arena( &parsec_zungqr->arenas_datatypes[PARSEC_zungqr_LITTLE_T_ADT_IDX  ] );
