                ...
                parsec_tiled_matrix_t* B )
{
    ...
    parsec_zunmqr = dplasma_zunmqr_New( dplasmaLeft, dplasmaConjTrans, A, T, B );
    parsec_ztrsm  = dplasma_ztrsm_New(  dplasmaLeft, dplasmaUpper, dplasmaNoTrans, dplasmaNonUnit, 1.0, subA, subB );
