                ...
                int* info )
{
    ...
    if( dplasmaLower == uplo ) {
        ...
        dplasma_add2arena_rectangle( &h2b->arenas_datatypes[PARSEC_zhetrd_h2b_L_DEFAULT_ADT_IDX],
                                     A->mb*A->nb*sizeof(dplasma_complex64_t),
                                     PARSEC_ARENA_ALIGNMENT_SSE,
                                     parsec_datatype_double_complex_t, A->mb, A->nb, -1 );
        dplasma_add2arena_rectangle( &h2b->arenas_datatypes[PARSEC_zhetrd_h2b_L_LITTLE_T_ADT_IDX],
        ...
        dplasma_add2arena_rectangle( &h2b->arenas_datatypes[PARSEC_zhetrd_h2b_U_DEFAULT_ADT_IDX],
                                     A->mb*A->nb*sizeof(dplasma_complex64_t),
                                     PARSEC_ARENA_ALIGNMENT_SSE,
                                     parsec_datatype_double_complex_t, A->mb, A->nb, -1 );
        dplasma_add2arena_rectangle( &h2b->arenas_datatypes[PARSEC_zhetrd_h2b_U_LITTLE_T_ADT_IDX],
                                     T->mb*T->nb*sizeof(dplasma_complex64_t),
                                     PARSEC_ARENA_ALIGNMENT_SSE,
                                     parsec_datatype_double_complex_t, T->mb, T->nb, -1 );
#endif
    ...
    dplasma_add2arena_rectangle( &b2s->arenas_datatypes[PARSEC_zhetrd_b2s_DEFAULT_ADT_IDX],
