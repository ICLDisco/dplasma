                    ...
                    parsec_tiled_matrix_dc_t *A )
{
    ...
    if ( uplo == dplasmaLower ) {
        ...
        dplasma_add2arena_lower( &((parsec_zlauum_L_taskpool_t*)parsec_lauum)->arenas_datatypes[PARSEC_zlauum_L_LOWER_TILE_ARENA],
        ...
        dplasma_add2arena_upper( &((parsec_zlauum_U_taskpool_t*)parsec_lauum)->arenas_datatypes[PARSEC_zlauum_U_UPPER_TILE_ARENA],
                                 A->mb*A->nb*sizeof(dplasma_complex64_t),
                                 PARSEC_ARENA_ALIGNMENT_SSE,
                                 parsec_datatype_double_complex_t, A->mb, 1 );
    }

    dplasma_add2arena_tile( &((parsec_zlauum_L_taskpool_t*)parsec_lauum)->arenas_datatypes[PARSEC_zlauum_L_DEFAULT_ARENA],
                            A->mb*A->nb*sizeof(dplasma_complex64_t),
                            PARSEC_ARENA_ALIGNMENT_SSE,
...
dplasma_zlauum_Destruct( parsec_taskpool_t *tp )
{
    ...
    dplasma_matrix_del2arena( &olauum->arenas_datatypes[PARSEC_zlauum_L_DEFAULT_ARENA   ] );
    dplasma_matrix_del2arena( &olauum->arenas_datatypes[PARSEC_zlauum_L_LOWER_TILE_ARENA] );
