                    ...
                    parsec_tiled_matrix_dc_t *C )
{
    ...
    parsec_private_memory_init( ((parsec_zunmqr_LC_taskpool_t*)tp)->_g_pool_0, ib * T->nb * sizeof(dplasma_complex64_t) );

    /* Default type */
    dplasma_add2arena_tile( &((parsec_zunmqr_LC_taskpool_t*)tp)->arenas_datatypes[PARSEC_zunmqr_LC_DEFAULT_ADT_IDX],
                            A->mb*A->nb*sizeof(dplasma_complex64_t),
                            PARSEC_ARENA_ALIGNMENT_SSE,
                            parsec_datatype_double_complex_t, A->mb );

    /* Lower triangular part of tile without diagonal */
    dplasma_add2arena_lower( &((parsec_zunmqr_LC_taskpool_t*)tp)->arenas_datatypes[PARSEC_zunmqr_LC_LOWER_TILE_ADT_IDX],
                             A->mb*A->nb*sizeof(dplasma_complex64_t),
                             PARSEC_ARENA_ALIGNMENT_SSE,
                             parsec_datatype_double_complex_t, A->mb, 0 );

    /* Little T */
    dplasma_add2arena_rectangle( &((parsec_zunmqr_LC_taskpool_t*)tp)->arenas_datatypes[PARSEC_zunmqr_LC_LITTLE_T_ADT_IDX],
...
dplasma_zunmqr_Destruct( parsec_taskpool_t *tp )
{
    ...
    dplasma_matrix_del2arena( &parsec_zunmqr->arenas_datatypes[PARSEC_zunmqr_LC_DEFAULT_ADT_IDX   ] );
    dplasma_matrix_del2arena( &parsec_zunmqr->arenas_datatypes[PARSEC_zunmqr_LC_LOWER_TILE_ADT_IDX] );
    dplasma_matrix_del2arena( &parsec_zunmqr->arenas_datatypes[PARSEC_zunmqr_LC_LITTLE_T_ADT_IDX  ] );
