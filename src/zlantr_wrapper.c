                    ...
                    double *result )
{
    ...
    /* Set the datatypes */
    dplasma_add2arena_tile( &((parsec_zlange_frb_cyclic_taskpool_t*)parsec_zlantr)->arenas_datatypes[PARSEC_zlange_frb_cyclic_DEFAULT_ARENA],
                            A->mb*A->nb*sizeof(dplasma_complex64_t),
                            PARSEC_ARENA_ALIGNMENT_SSE,
                            parsec_datatype_double_complex_t, A->mb );
    dplasma_add2arena_rectangle( &((parsec_zlange_frb_cyclic_taskpool_t*)parsec_zlantr)->arenas_datatypes[PARSEC_zlange_frb_cyclic_COL_ARENA],
                                 mb * nb * sizeof(double), PARSEC_ARENA_ALIGNMENT_SSE,
                                 parsec_datatype_double_t, mb, nb, -1 );
    dplasma_add2arena_rectangle( &((parsec_zlange_frb_cyclic_taskpool_t*)parsec_zlantr)->arenas_datatypes[PARSEC_zlange_frb_cyclic_ELT_ARENA],
...
dplasma_zlantr_Destruct( parsec_taskpool_t *tp )
{
    ...
    dplasma_matrix_del2arena( &parsec_zlantr->arenas_datatypes[PARSEC_zlange_frb_cyclic_DEFAULT_ARENA] );
    dplasma_matrix_del2arena( &parsec_zlantr->arenas_datatypes[PARSEC_zlange_frb_cyclic_COL_ARENA] );
    dplasma_matrix_del2arena( &parsec_zlantr->arenas_datatypes[PARSEC_zlange_frb_cyclic_ELT_ARENA] );
