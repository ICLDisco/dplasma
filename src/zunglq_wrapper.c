 ...
 ******************************************************************************/
parsec_taskpool_t*
dplasma_zunglq_New( parsec_tiled_matrix_t *A,
                    ...
                    parsec_tiled_matrix_t *Q )
{
    ...
    /* Default type */
    dplasma_add2arena_tile( &tp->arenas_datatypes[PARSEC_zunglq_DEFAULT_ADT_IDX],
                            A->mb*A->nb*sizeof(dplasma_complex64_t),
                            PARSEC_ARENA_ALIGNMENT_SSE,
                            parsec_datatype_double_complex_t, A->mb );

    /* Upper triangular part of tile without diagonal */
    dplasma_add2arena_upper( &tp->arenas_datatypes[PARSEC_zunglq_UPPER_TILE_ADT_IDX],
                             A->mb*A->nb*sizeof(dplasma_complex64_t),
                             PARSEC_ARENA_ALIGNMENT_SSE,
                             parsec_datatype_double_complex_t, A->mb, 0 );

    /* Little T */
    dplasma_add2arena_rectangle( &tp->arenas_datatypes[PARSEC_zunglq_LITTLE_T_ADT_IDX],
...
dplasma_zunglq_Destruct( parsec_taskpool_t *tp )
{
    ...
    dplasma_matrix_del2arena( &parsec_zunglq->arenas_datatypes[PARSEC_zunglq_DEFAULT_ADT_IDX   ] );
    dplasma_matrix_del2arena( &parsec_zunglq->arenas_datatypes[PARSEC_zunglq_UPPER_TILE_ADT_IDX] );
    dplasma_matrix_del2arena( &parsec_zunglq->arenas_datatypes[PARSEC_zunglq_LITTLE_T_ADT_IDX  ] );
