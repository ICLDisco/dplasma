 ...
 *
 * @param[in] seed
 *         The seed used for cores/random generation. Must be the same for
                  ...
                  unsigned long long int seed )
{
    ...
    case PlasmaMatrixCompan:
    {
        ...
        if ( m0 == 0 ) {
            ...
            /* Initialize cores/random vector */
   ...
   case PlasmaMatrixWilkinson:
     ...
     *
     * Returns a cores/random matrix on which, the columns from N/4 to N/2
